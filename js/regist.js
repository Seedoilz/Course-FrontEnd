...
function checkRename(){
    ...
    //2.定义正则表达式
    var reg_rename = /^[\u4e00-\u9fa5]{1,5}$/;var reg_username = /^([a-zA-Z0-9_-])/;
    //3.判断值是否符合正则的规则
    ...
    // if(flag){
    //     //提示绿色对勾
    //     s_rename.innerHTML = "<img width='35' height='25' src='img/gou.png'/>";
    // }else{
    //     //提示红色错误信息
    //     s_rename.innerHTML = "昵称输入有误";
    // }
    return flag;
}
//校验手机号
function checkTelphone(){
    ...
    // if(flag){
    //     //提示绿色对勾
    //     s_telphone.innerHTML = "<img width='35' height='25' src='img/gou.png'/>";
    // }else{
    //     //提示红色错误信息
